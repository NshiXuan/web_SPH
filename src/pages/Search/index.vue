            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a>
                    综合
                    <span v-show="isOne" class="iconfont" :class="{ 'icon-todown': isAsc, 'icon-up': isDesc }"></span>
                  </a>
                </li>
                <li :class="{ active: isTwo }" @click="changeOrder('2')">
                  <a>
                    价格
                    <span v-show="isTwo" class="iconfont" :class="{ 'icon-todown': isAsc, 'icon-up': isDesc }"></span>
                  </a>
                </li>
              </ul>
            </div>
...
export default {
  ...
  methods: {
    // 向服务器发请求获取search模块数据（根据不同参数返回不同数据进行展示）
    getData() {
